            ...
            <div class="accordion">
              <div class="accordion-item bg-white border border-gray-200">
                <h2 class="accordion-header mb-0" id="headingOne">
                  <button class="accordion-button relative flex items-center 1  p-5" type="button" data-bs-toggle="collapse" data-bs-target="#collapseOne" aria-expanded="true" aria-controls="collapseOne">
                    <svg class="w-6 h-6 mr-2" fill="currentColor" viewBox="0 0 24 24">
                      <path d="M19 9l-7 7-7-7" />
                    </svg>
                    Pertanyaan 1
                  </button>
                  <p>              Ini adalah jawaban untuk pertanyaan pertama. Anda dapat menambahkan lebih banyak teks di sini.</p>
                  <p>              Anda juga  bisa menambahkan elemen HTML lainnya seperti gambar atau daftar.</p>
                </h2>
                <div id="collapseOne" class="accordion-collapse collapse show" aria-labelledby="headingOne" data-bs-parent="#accordionExample">
                  <div class="accordion-body p-5">
                    Jawaban untuk pertanyaan 1.
                    <p>Ini adalah jawaban untuk pertanyaan pertama. Anda dapat menambahkan lebih banyak teks di sini.</p>
                    <p>Anda juga bisa menambahkan elemen HTML lainnya seperti    tau daftar.</p>
                  </div>
                </div>
              </div>
            </div>
