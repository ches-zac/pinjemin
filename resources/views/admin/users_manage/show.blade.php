            ...
            <table class="table-auto w-full border border-gray-200">
                <thead>
                    <tr class="bg-teal-300">
                        ...
                        <th class="border border-gray-200 py-2">Email</th>
                        <th class="border border-gray-200 py-2">No.HP</th>
                        <th class="border border-gray-200 py-2">Role</th>
                ...
                <tbody>
                    ...
                    @empty
                        <tr>
                            <td colspan="6" class="border border-gray-200 py-2 text-center">{{ "Data Tidak Tersedia" }}</td>
                        </tr>
                    @endforelse
                </tbody>
            </table>
        ...
        <table class="table-auto w-full border border-gray-200">
            ...
            @forelse ($users as $index => $user)
                <tr>
                    ...
                    <td class="border border-gray-200 py-2 text-center">{{ $user->nama }}</td>
                    <td class="border border-gray-200 py-2 text-center">{{ $user->email }}</td>
                    <td class="border border-gray-200 py-2 text-center">{{ $user->no_telp ?? '-' }}</td>
                    <td class="border border-gray-200 py-2 text-center">{{ ucfirst($user->role) }}</td>
                    <td class="border border-gray-200 py-2 text-center flex justify-center space-x-2">
                        <!-- Tombol Edit -->
            ...
            @empty
                <tr>
                    <td colspan="6" class="border border-gray-200 py-2 text-center text-gray-500">Data Tidak Tersedia</td>
                </tr>
            @endforelse
            </tbody>
        </table>
