...
<div id="sidebar" class="bg-blue-400 w-16 transition-all duration-300 flex flex-col items-center py-6 overflow-hidden min-h-screen fixed shadow-lg">
    ...
    <nav class="space-y-6 w-full">
        <a href="{{ route('admin.dashboard') }}" class="text-black flex items-center gap-4 p-2 hover:bg-teal-400 rounded-md">
        ...
        <a href="{{ route('show.users') }}" class="text-black flex items-center gap-4 p-2 hover:bg-teal-400 rounded-md">
            <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 nav-icon mx-auto" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            <span class="icon_desc hidden">Manage User</span>
        </a>
        <a href="{{ route('admin.inventory.index') }}" class="text-black flex items-center gap-4 p-2 hover:bg-teal-400 rounded-md">
            <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 nav-icon mx-auto" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            <span class="icon_desc hidden">Item Inventory</span>
        </a>
        <a href="{{ route('admin.lending.history') }}" class="text-black flex items-center gap-4 p-2 hover:bg-teal-400 rounded-md">
            <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 nav-icon mx-auto" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            <span class="icon_desc hidden">Riwayat Peminjaman</span>
        </a>
