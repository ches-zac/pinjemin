    ...
    <div class="w-1/2 lg:w-1/3 md:w-2/3 sm:w-full bg-white rounded-lg shadow-md overflow-hidden h-[80vh] flex flex-col">
        <div class="p-8 overflow-y-auto">
            ...
            <form action="{{ route('update.profile') }}" method="POST" enctype="multipart/form-data">
                ...
                <!-- Profile Picture -->
                <div class="mb-6">
                    <label for="profile_picture" class="block mb-2 text-sm font-medium text-black">Foto Profil</label>
                    <input type="file" id="profile_picture" name="profile_picture"
                        class="block w-full text-sm text-white bg-[#dd7c1b] rounded-lg border border-white cursor-pointer focus:outline-none">
                </div>
