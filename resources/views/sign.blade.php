  ...
  <div class="w-full max-w-[800px] mx-auto flex shadow-lg bg-white rounded-lg overflow-hidden">
    ...
    <div class="w-1/2 p-8 flex flex-col justify-center">
      ...
      <form class="space-y-4">
        ...
        <!-- Login Button -->
        <button type="submit" class="w-full space-y-8 bg-blue-500 hover:bg-blue-600 text-white rounded-lg py-2 font-semibold">
          Login
        </button>

        <!-- SignUP Button -->
        <button type="submit" class="w-full space-y-4 bg-blue-500 hover:bg-blue-600 text-white rounded-lg py-2 font-semibold">
            SignUp
        </button>
